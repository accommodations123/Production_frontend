...
export default function NewDashboard() {
  ...
  return (
    <main className="min-h-screen bg-[#F6F8FA] pb-20 font-sans antialiased text-gray-900">
      
      {/* 1. Large Cover Banner & Profile Area */}
      <div className="w-full relative bg-white border-b border-gray-200/60 shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
        {/* Cover graphic mesh */}
        <div className="h-44 sm:h-64 bg-gradient-to-br from-[#0B1528] via-[#0F223D] to-[#1E3E66] relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 -mt-10 sm:-mt-16">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-end gap-5 text-center sm:text-left">
              ...
              <div className="relative group shrink-0 transition-transform duration-300 hover:scale-[1.02]">
                ...
                <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full border-4 border-white bg-white shadow-xl overflow-hidden relative z-10">
                  {currentUser?.profile_image && !currentUser.profile_image.includes("ImageOff") ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-[#0B1528] to-[#1E3E66] text-white flex items-center justify-center text-4xl font-extrabold uppercase select-none">
              ...
              {/* Bio Details */}
              <div className="space-y-1 sm:mb-2 z-10">
            ...
            <div className="flex flex-wrap justify-center lg:justify-end gap-2.5 sm:mb-2 shrink-0">
              <button
                ...
                className="flex items-center gap-1.5 bg-[#0B1528] hover:bg-blue-700 text-white font-bold text-xs px-4 py-2.5 rounded-xl shadow-md transition-all hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs px-4 py-2.5 rounded-xl shadow-md transition-all hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
              >
      ...
      <div className="border-b border-gray-200/50 bg-white sticky top-0 z-30 shadow-[0_2px_15px_rgba(0,0,0,0.015)]">
            ...
            {mobileTabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all duration-200 cursor-pointer hover-lift ${isActive
                    ? 'bg-[#0B1528] text-white shadow-lg shadow-[#0B1528]/15'
                    : 'bg-white text-[#484848] border border-gray-200/80 hover:bg-gray-50 hover:text-gray-900'
                    }`}
                >
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <MetricCard
                ...
                icon={Home}
                color="from-blue-500 to-indigo-600 animate-in fade-in duration-200"
              ...
              <MetricCard
                ...
                icon={Plane}
                color="from-indigo-500 to-purple-600 animate-in fade-in duration-300"
                onClick={() => navigate("?tab=trips")}
              />
              <MetricCard
                title="Applications"
                ...
                icon={Briefcase}
                color="from-emerald-500 to-teal-600 animate-in fade-in duration-400"
              ...
              <MetricCard
                ...
                icon={Heart}
                color="from-rose-500 to-pink-600 animate-in fade-in duration-500"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                {/* Welcome Card */}
                <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-200/50 shadow-[0_8px_30px_rgba(0,0,0,0.015)] relative overflow-hidden flex flex-col sm:flex-row items-center justify-between gap-6">
                  <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-br from-blue-50/50 to-indigo-50/50 rounded-full blur-3xl pointer-events-none -z-10"></div>
                  <div className="space-y-2 text-center sm:text-left">
                    <span className="text-xs font-bold text-blue-600 tracking-wider uppercase block">Portal Access</span>
                    <h2 className="text-xl sm:text-2xl font-black text-gray-900 tracking-tight">
                      {getGreeting()}, {currentUser?.firstName || "Traveler"}!
                    </h2>
                    <p className="text-xs sm:text-sm text-[#484848] max-w-md leading-relaxed">
                  ...
                  <button
                    ...
                    className="h-10 px-5 bg-blue-50 border border-blue-100 rounded-xl text-blue-700 font-extrabold text-xs shadow-sm hover:bg-blue-100 transition-colors shrink-0 cursor-pointer flex items-center gap-1.5"
                  >
                ...
                <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-200/50 shadow-[0_8px_30px_rgba(0,0,0,0.015)] space-y-5">
                  ...
                  {tripsData?.trips?.length > 0 ? (
                    (() => {
                      ...
                      return (
                        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0B1528] via-[#0F223D] to-[#173254] p-6 text-white shadow-xl">
                          {/* Design accents */}
                          ...
                          <div className="mt-8 pt-5 border-t border-white/10 flex items-center justify-between text-xs text-white/70 relative z-10">
                            ...
                            <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-600/90 text-white font-black text-[10px] tracking-wider uppercase border border-blue-400/20 shadow-md">
                              CONFIRMED
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="py-14 text-center rounded-2xl border border-dashed border-gray-200/80 bg-gray-50/50 flex flex-col items-center justify-center space-y-3">
                      <Compass className="w-10 h-10 text-gray-300" />
                      <div className="space-y-1">
                        <p className="text-sm font-bold text-gray-700">No active itineraries</p>
                        <p className="text-xs text-[#717171] max-w-xs leading-relaxed">Planning a relocation flight? Post your trip to discover co-travelers.</p>
                      </div>
                      <button
                        onClick={() => navigate("?tab=trips")}
                        className="h-8.5 px-4 bg-white border border-gray-200 hover:bg-gray-50 rounded-lg text-xs font-bold text-gray-700 cursor-pointer shadow-sm transition-all"
                      >
                        Plan Journey Now
                      </button>
                    </div>
              ...
              {/* Right Column (4 cols) - Trust & Profile Status */}
              <div className="lg:col-span-4 space-y-6">
                
                <div className="bg-white rounded-3xl p-6 border border-gray-200/50 shadow-[0_8px_30px_rgba(0,0,0,0.015)] space-y-6">
                  
                  {/* Visual Header */}
                  <div className="flex items-center justify-between pb-4 border-b border-gray-50">
                    <h3 className="font-extrabold text-gray-900 text-sm">Account Trust Profile</h3>
                  ...
                  {/* Circular SVG Completion Meter */}
                  <div className="bg-gradient-to-br from-gray-50 to-white/50 border border-gray-100 rounded-2xl p-4 flex items-center gap-4 shadow-sm">
                    <div className="relative shrink-0 flex items-center justify-center">
                      ...
                      <span className="absolute text-sm font-black text-gray-900">{completionScore}%</span>
                    </div>
                    <div className="space-y-1">
                      <p className="font-black text-gray-900 text-xs">Profile Completeness</p>
                      <p className="text-[10px] text-[#717171] leading-relaxed">
                        {completionScore < 100 
                          ? "Add missing info in Profile settings to reach 100% and build trust."
                          : "Your profile is fully detailed! Ready for verified bookings."
                        }
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <h4 className="text-[10px] uppercase font-bold text-[#717171] tracking-wider ml-1">Verifications</h4>
                  ...
                  <div className="space-y-3 pt-2 border-t border-gray-50">
                    <h4 className="text-[10px] uppercase font-bold text-[#717171] tracking-wider ml-1">Connected Channels</h4>
...
const MetricCard = ({ title, value, icon: Icon, color, onClick }) => (
  <div 
    onClick={onClick}
    className="group bg-white rounded-3xl p-5 border border-gray-200/50 shadow-[0_4px_20px_rgba(0,0,0,0.01)] hover:shadow-[0_12px_30px_rgba(0,0,0,0.04)] hover:border-blue-500/10 transition-all duration-300 cursor-pointer flex items-center justify-between relative overflow-hidden"
  >
    <div className="space-y-1.5 relative z-10">
      <p className="text-[10px] font-bold text-[#717171] uppercase tracking-wider">{title}</p>
    ...
    <div className={cn("w-11 h-11 rounded-2xl bg-gradient-to-br flex items-center justify-center text-white relative z-10 shadow-md group-hover:rotate-6 transition-transform duration-300", color)}>
...
const VerificationRow = ({ label, verified, icon: Icon }) => (
  <div className="flex items-center justify-between text-xs py-2 px-3 bg-gray-50/50 hover:bg-gray-50 rounded-xl border border-gray-100 transition-colors">
