...
export default function HelpPage() {
    ...
    return (
        <main className="min-h-screen bg-[#ffffff] font-sans">
            ...
            {/* Content Container */}
            <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8 -mt-12 relative z-20">
                {/* Categories */}
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                    <CategoryCard
                        icon={Book}
                        title="Getting Started"
                        description="New to NextKinLife? Learn how to find accommodations and connect with the community."
                    />
                    <CategoryCard
                        icon={Home}
