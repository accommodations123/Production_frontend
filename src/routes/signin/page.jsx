  ...
  return (
    <div className="min-h-screen w-full bg-[#ffffff] relative overflow-hidden flex items-center justify-center p-4 md:p-8">
      ...
      <motion.div
        ...
        className="absolute -bottom-[30%] -right-[20%] w-[80vh] h-[80vh] rounded-full bg-accent blur-[200px] z-0"
      />
      <motion.div
      ...
      <div className="relative z-10 w-full max-w-5xl md:min-h-[650px] bg-white rounded-3xl shadow-2xl shadow-[#00142E]/10 overflow-hidden grid md:grid-cols-[1.1fr_1fr] border border-[#D1CBB7]/30">
        ...
        <div className="hidden md:flex relative bg-gradient-to-br from-[#00142E] via-[#0A1C30] to-[#02152B] text-white flex-col justify-between p-8 md:p-10 xl:p-14 overflow-hidden">
          ...
          {/* Accent Line */}
          <div className="absolute top-0 left-0 w-1.5 h-full bg-gradient-to-b from-accent via-accent/50 to-transparent" />

          {/* Glowing Orb */}
          <motion.div
            animate={{ scale: [1, 1.15, 1], opacity: [0.3, 0.5, 0.3] }}
            transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
            className="absolute -bottom-32 -right-32 w-80 h-80 bg-accent rounded-full blur-[120px]"
          />
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <h1 className="text-4xl xl:text-5xl font-bold leading-tight mb-5">
                  {step === 'email' ? (
                    <>Welcome to <br /><span className="text-accent">Your Community</span></>
                  ) : (
                    <>One Step <br /><span className="text-accent">Closer</span></>
                  )}
                </h1>
          ...
          <div className="max-w-sm w-full mx-auto">
            ...
            <AnimatePresence mode="wait">
              {step === 'email' ? (
                  ...
                  <form onSubmit={handleSendOtp} className="space-y-5">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative group">
                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-[#00142E]/30 group-focus-within:text-accent transition-colors h-5 w-5" />
                        <input
                          type="email"
                          name="email"
                          ...
                          className="w-full bg-[#D1CBB7]/10 border-2 border-transparent text-[#00142E] rounded-xl py-4 pl-12 pr-4 outline-none focus:bg-white focus:border-accent focus:ring-4 focus:ring-accent/10 transition-all font-medium placeholder:text-[#00142E]/30"
                          required
                        />
                      </div>
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={sendingOtp}
                      className="w-full h-14 bg-accent hover:bg-accent/95 text-white rounded-xl font-bold text-base shadow-lg shadow-accent/25 transition-all hover:shadow-xl hover:shadow-accent/30 active:scale-[0.98] disabled:opacity-70 flex items-center justify-center gap-2"
                    >
                ...
                >
                  <div className="mb-8">
                    <button onClick={() => setStep('email')} className="text-sm font-medium text-[#00142E]/50 hover:text-accent flex items-center gap-1.5 mb-5 transition-colors group">
                  ...
                  <form onSubmit={handleVerifyOtp} className="space-y-6">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative group">
                        <KeyRound className="absolute left-4 top-1/2 -translate-y-1/2 text-[#00142E]/30 group-focus-within:text-accent transition-colors h-5 w-5" />
                        <input
                          type="text"
                          name="otp"
                          value={formData.otp}
                          ...
                          className="w-full bg-[#D1CBB7]/10 border-2 border-transparent text-[#00142E] rounded-xl py-4 pl-12 pr-4 outline-none focus:bg-white focus:border-accent focus:ring-4 focus:ring-accent/10 transition-all font-bold tracking-[0.3em] text-lg placeholder:text-[#00142E]/30 placeholder:tracking-normal placeholder:font-medium"
                          maxLength={6}
                          required
                        />
                      </div>
