...
export default function WishlistPage() {
    ...
    const renderContent = () => {
        ...
        return (
            <div className={activeTab === 'buysell' ? "grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-5" : "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"}>
                {data.wishlist.map((item) => {
                    ...
                    switch (activeTab) {
                        ...
                        case 'trip': {
                            ...
                            return <TravelPartnerCard key={item.id} plan={normalizedTrip} isSelected={false} />;
                        }
