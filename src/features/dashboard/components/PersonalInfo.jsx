...
export function PersonalInfo({ initialData, verificationState, onUpdate, isUpdating, isHost }) {
  ...
  const displayName = formData.full_name || 'Bhargav Reddy';
    ...
    <div className="space-y-6 animate-in fade-in duration-300 text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div className="lg:col-span-8 space-y-6">
          ...
          <SocialSection editStates={editStates} toggleEdit={toggleEdit} isUpdating={isUpdating} formData={formData} handleChange={handleChange} />
        </div>
      </div>
    </div>
  );
