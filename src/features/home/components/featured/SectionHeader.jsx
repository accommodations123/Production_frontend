    ...
    <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
        ...
        <div className="flex flex-col items-start md:items-end gap-2 shrink-0">
            {actionText && actionTo && (
                <Link
                    to={actionTo}
                    className="flex items-center gap-1.5 px-4 py-2 bg-[#CB2A25] hover:bg-[#a0221e] text-white font-bold rounded-full text-xs shadow-md transition-all hover:scale-105 duration-300 mb-1"
