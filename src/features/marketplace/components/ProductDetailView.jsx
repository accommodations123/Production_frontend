  ...
  return (
    <div className="pt-2 bg-[#FAFBFD] min-h-screen" style={{ fontFamily: BODY_FONT }}>
            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 p-6 shadow-[0_8px_32px_rgba(0,0,0,0.02)] space-y-6">
              ...
              <div className="border-t border-slate-100 pt-5">
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-black text-[#222222]">{formatPrice(price)}</span>
                  {original > price && (
                    <>
                      <span className="text-sm text-slate-400 font-bold line-through">{formatPrice(original)}</span>
              ...
              <div className="border-t border-slate-100 pt-5 flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5 text-xs text-[#484848] font-semibold mt-0.5">
                      {rating > 0 && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 p-6 shadow-[0_8px_32px_rgba(0,0,0,0.015)]">
              ...
              >
                ...
                <div className="absolute bottom-3 right-3 bg-white rounded-xl px-3 py-1.5 text-xs text-[#484848] shadow border border-slate-100 cursor-pointer font-bold hover:bg-slate-50 transition-colors">
                  Map View
                </div>
              </div>
                        ...
                        <div className="border-t border-slate-100 pt-3 flex items-center justify-between">
                          ...
                          {(item.sellerRating || item.rating) && (
                            <div className="flex items-center gap-1 text-xs text-amber-500 font-bold">
                              <Star size={11} className="fill-amber-400 text-amber-400" />
                              {(item.sellerRating || item.rating).toFixed(1)}
                            </div>
                          )}
                        </div>
                      </div>
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div id="seller-info" className="bg-white rounded-2xl border border-slate-200/60 p-5 shadow-[0_8px_32px_rgba(0,0,0,0.015)] space-y-4">
              ...
              {/* Seller metrics widget */}
              <div className="grid grid-cols-3 gap-1 py-3 border-y border-slate-100 text-center bg-slate-50/50 rounded-xl">
                <div>
                  <span className="text-[9px] text-[#717171] font-bold uppercase tracking-wider block">Rating</span>
                ...
                <div className="border-x border-slate-200/60">
                  <span className="text-[9px] text-[#717171] font-bold uppercase tracking-wider block">Resp. Rate</span>
                  <span className="text-xs font-bold text-slate-800 block mt-1">{responseRate || "—"}</span>
                </div>
                <div>
                  <span className="text-[9px] text-[#717171] font-bold uppercase tracking-wider block">Avg. Time</span>
                  <span className="text-xs font-bold text-slate-800 block mt-1">{responseTime || "—"}</span>
                </div>
              </div>
      ...
      <div className="md:hidden fixed bottom-[56px] left-0 right-0 bg-white border-t border-slate-200 px-4 py-3 flex items-center justify-between gap-3 z-40 shadow-lg">
        <div>
          <div className="text-lg font-black text-[#222222]">{formatPrice(price)}</div>
