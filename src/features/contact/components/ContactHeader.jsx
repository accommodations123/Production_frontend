    ...
    return (
        <div className="text-center mb-20">
            ...
            <motion.div
                ...
                className="inline-flex items-center gap-2 bg-[#E1392A]/10 backdrop-blur-sm border border-[#E1392A]/20 rounded-full px-6 py-3 mb-8"
            >
                <Sparkles className="h-4 w-4 text-[#E1392A] animate-pulse" />
            ...
            >
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E1392A] to-[#D1CBB7]">
                    Something Amazing
                </span>
            </motion.h1>
                    ...
                    return (
                        <div key={index} className="group">
                            <div className="flex flex-col items-center">
                                <div className="p-3 bg-[#E1392A]/10 rounded-xl group-hover:bg-[#E1392A]/20 transition-colors mb-3">
            ...
            >
                <button className="group px-8 py-4 bg-[#E1392A] hover:bg-[#a82220] text-white font-semibold rounded-xl shadow-lg shadow-[#E1392A]/25 transition-all hover:shadow-xl hover:scale-[1.02]">
                    Start a Project
