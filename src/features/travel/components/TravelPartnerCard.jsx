...
const TravelPartnerCard = React.memo(({ plan }) => {
    ...
    return (
        <div className="group bg-white rounded-3xl border border-gray-200/80 hover:border-[#E1392A]/25 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-[350px] flex flex-col overflow-hidden">
            ...
            <div className="p-3.5 flex-grow flex flex-col gap-2 min-h-0">
                ...
                <div className="flex items-center gap-3">
                    {profileImage && !imageError ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#E1392A] to-[#D8423C] flex items-center justify-center text-white font-bold text-sm shrink-0">
