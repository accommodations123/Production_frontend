...
import { Plane, Calendar, Globe, Shield } from "lucide-react";
...
const TravelPartnerCard = React.memo(({ plan }) => {
    ...
    return (
        <div className="group bg-white rounded-3xl border border-gray-200/80 hover:border-[#CB2A25]/25 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-[350px] flex flex-col overflow-hidden">
            {/* Flight Route Header — compact gradient banner */}
            <div className="relative h-[150px] bg-gradient-to-br from-[#00142E] to-[#0A2847] px-4 py-4 text-white flex flex-col justify-between shrink-0">
                {/* Wishlist top-right */}
            ...
            <div className="p-3.5 flex-grow flex flex-col gap-2 min-h-0">
                ...
                <div className="flex items-center gap-3">
                    {profileImage && !imageError ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#CB2A25] to-[#D8423C] flex items-center justify-center text-white font-bold text-sm shrink-0">
                ...
                <div className="flex items-center justify-between gap-2 mt-auto pt-3 border-t border-gray-100 h-[60px] shrink-0">
                    {formattedDate && (
