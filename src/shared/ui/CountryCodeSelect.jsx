    ...
    return (
        <div className={cn("relative", className)} ref={ref}>
            <button
                ...
                className={cn(
                    "flex items-center justify-between gap-1.5 px-3 h-full min-h-[36px] bg-white border border-gray-200 rounded-xl hover:border-gray-300 transition-all w-full",
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: 5 }}
                        className="absolute top-full left-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl shadow-black/10 border border-gray-100 max-h-64 flex flex-col z-50 overflow-hidden"
                    >
                        {/* Search Input */}
                        <div className="p-2 border border-neutral/10 bg-white sticky top-0 z-10">
                            <input
                                ...
                                autoFocus
                                className="w-full px-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-accent/50 focus:ring-2 focus:ring-accent/10 focus:bg-white transition-colors"
                            />
                        </div>
