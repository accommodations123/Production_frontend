    ...
    return (
        <div className={cn("relative w-full", className)} ref={dropdownRef}>
            ...
            <div
                ...
                className={cn(
                    "relative flex items-center justify-between w-full px-4 py-3 border rounded-xl cursor-pointer transition-all shadow-[0_1px_2px_rgba(0,0,0,0.03)]",
                    isOpen ? "border-accent ring-4 ring-accent/10 bg-white" : "border-gray-200 bg-white hover:border-gray-300",
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        className="absolute z-50 w-full mt-2 bg-white border border-gray-100 rounded-2xl shadow-2xl shadow-black/10 overflow-hidden"
                    >
                        <div className="sticky top-0 bg-white p-2 border-b border-gray-100">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    autoFocus
                                    type="text"
                                    className="w-full pl-9 pr-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg outline-none focus:border-accent focus:ring-2 focus:ring-accent/10 transition-all text-black"
                        ...
                        <div className="max-h-60 overflow-y-auto py-1">
                                ...
                                filteredOptions.map((option, index) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={cn(
                                                "px-4 py-2 text-sm cursor-pointer flex items-center justify-between hover:bg-accent hover:text-white transition-all",
                                                isSelected ? "bg-accent/10 text-accent font-medium" : "text-gray-700"
                                            )}
                            ...
                            {searchQuery && (
                                <div
                                    className="px-4 py-2.5 text-sm cursor-pointer flex items-center justify-between text-accent bg-accent/5 hover:bg-accent hover:text-white transition-all font-semibold border-t border-gray-100"
