...
export const reviewService = {
    getEventReviews: async (eventId) => {
        try {
            const response = await axiosClient.get(`events/reviews/${eventId}/reviews`);
    ...
    getEventRating: async (eventId) => {
        try {
            const response = await axiosClient.get(`events/reviews/${eventId}/rating`);
    ...
    submitReview: async (eventId, reviewData) => {
        try {
            const response = await axiosClient.post(`events/reviews/${eventId}/reviews`, reviewData);
            return response.data;
        } catch (error) {
    ...
    hideReview: async (reviewId) => {
        try {
            const response = await axiosClient.patch(`events/reviews/reviews/${reviewId}/hide`, {});
            return response.data;
        } catch (error) {
...
export const eventService = {
    ...
    leaveEvent: async (eventId) => {
        try {
            const response = await axiosClient.post(`events/${eventId}/leave`, {});
            return { success: true, ...response.data };
        } catch (error) {
